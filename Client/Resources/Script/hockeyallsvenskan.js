...
fetch(`${API_URL}/api/standings/ha`)
  ...
  .then((data) => {
    ...
    standingsGroups.forEach((team) => {
      ...
      teamLogo.src = `Resources/Images/Hockeyallsvenskan/${team.competitor.abbreviation}.svg`;
...
const renderRound = (roundIndex) => {
  ...
  round.matches.forEach((match) => {
    ...
    homeLogo.src = `Resources/Images/Hockeyallsvenskan/${match.sport_event.competitors[0].abbreviation}.svg`;
    ...
    awayLogo.src = `Resources/Images/Hockeyallsvenskan/${match.sport_event.competitors[1].abbreviation}.svg`;
