...
/* Kommenterat ut för att spara på calls

app.get("/api/standings/ha", async (req, res) => {
  try {
    const apiResponse = await fetch(
      `https://api.sportradar.com/icehockey/trial/v2/sv/seasons/sr%3Aseason%3A119025/standings.json?live=true&api_key=${API_KEY}`
    );
    const data = await apiResponse.json();
    res.json(data);
  } catch (error) {
    res.status(500).json({ error: "Ett fel uppstod vid hämtning av data" });
  }
});

app.get("/api/leaders/ha", async (req, res) => {
  try {
    const apiResponse = await fetch(
      `https://api.sportradar.com/icehockey/trial/v2/sv/seasons/sr%3Aseason%3A119025/leaders.json?live=true&api_key=${API_KEY}`
    );
    const data = await apiResponse.json();
    res.json(data);
  } catch (error) {
...
app.get("/api/standings/shl", async (req, res) => {
  try {
    const apiResponse = await fetch(
      `https://api.sportradar.com/icehockey/trial/v2/sv/seasons/sr%3Aseason%3A118915/standings.json?live=true&api_key=${API_KEY}`
    );
    const data = await apiResponse.json();
    res.json(data);
  } catch (error) {
...
app.get("/api/leaders/shl", async (req, res) => {
  try {
    const apiResponse = await fetch(
      `https://api.sportradar.com/icehockey/trial/v2/sv/seasons/sr%3Aseason%3A118915/leaders.json?live=true&api_key=${API_KEY}`
    );
    const data = await apiResponse.json();
    res.json(data);
  } catch (error) {
